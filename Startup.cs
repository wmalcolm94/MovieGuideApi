        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //if (Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "Production")
                services.AddDbContext<MovieGuideContext>(options =>
                        options.UseSqlServer("Server=tcp:movieguide.database.windows.net,1433;Initial Catalog=movieguide;Persist Security Info=False;User ID=wmalcolm;Password=Duffmckagan1994;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"));
            //else
            //    services.AddDbContext<MovieGuideContext>(options =>
